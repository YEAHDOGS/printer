import { Mr as define_property, N as teardown, c as set_active_effect, l as set_active_reaction, n as active_reaction, nr as hydrating, sn as queue_micro_task, t as active_effect, zt as without_reactive_context } from "./runtime-C9LCcyVl.js";
import { n as FILENAME } from "./constants-CAvLsAYl.js";
import { s as event_handler_invalid } from "./warnings-mTRJwfE3.js";
...
function apply(thunk, element, args, component, loc, has_side_effects = false, remove_parens = false) {
	...
	if (typeof handler !== "function" && (has_side_effects || handler != null || error)) {
		...
		event_handler_invalid(description, remove_parens ? "remove the trailing `()`" : "add a leading `() =>`");
