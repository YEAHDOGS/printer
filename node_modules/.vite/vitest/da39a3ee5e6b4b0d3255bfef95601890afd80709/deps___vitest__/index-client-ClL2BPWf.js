import { $n as hydrate_next, A as remove_effect_dom, An as bind_invalid_checkbox_value, Ar as array_from, Bn as lifecycle_legacy_only, Br as is_function, Bt as add_form_reset_listener, C as effect_root, Cn as get_error, Cr as LOADING_ATTR_SYMBOL, D as managed, Dr as STATE_SYMBOL, Dt as capture, F as user_effect, Fr as get_descriptor, Ft as unset_context, Gn as experimental_async_required, Gr as run_all, H as clear_text_content, Hn as props_rest_readonly, Hr as noop, I as user_pre_effect, In as get_abort_signal_outside_reaction, Ir as get_descriptors, J as get_first_child, Jn as lifecycle_outside_component, K as create_text, L as validate_effect, Ln as hydratable_missing_but_required, Lr as get_prototype_of, Lt as listen, M as resume_effect, Mn as component_api_invalid_new, Mr as define_property, N as teardown, Nn as each_key_duplicate, O as move_effect, On as snapshot, Or as STYLE_CACHE, Ot as flatten, P as template_effect, Pn as each_key_volatile, Qn as safe_not_equal, Rt as listen_to_event_and_reset_event, S as effect, Sn as set_dev_current_component_function, Sr as LEGACY_PROPS, St as previous_batch, Tn as tag, Tt as derived_safe_equal, U as create_comment, Un as rune_outside_svelte, Ur as object_keys, Ut as capture_store_binding, Vn as props_invalid_value, Vr as is_promise, Vt as autofocus, W as create_element, Wr as run, Y as get_next_sibling, _ as branch, _n as mark_as_component, _r as FORM_RESET_HANDLER, _t as current_batch, a as get, ar as reset, at as is, b as destroy_effect, c as set_active_effect, cr as skip_nodes, ct as internal_set, d as tick, dn as dev_current_component_function, dt as set, er as hydrate_node, f as untrack, fn as dev_stack, ft as source, g as block, gn as is_runes, gr as EFFECT_TRANSPARENT, gt as Batch, i as deep_read_state, ir as read_hydration_instruction, j as render_effect, jn as component_api_changed, jt as run_after_blockers, k as pause_effect, l as set_active_reaction, ln as component_context, lr as ATTRIBUTES_CACHE, lt as mutable_source, mr as EFFECT_OFFSCREEN, mt as update, n as active_reaction, nr as hydrating, o as is_destroying_effect, or as set_hydrate_node, ot as proxy, qn as invalid_snippet_arguments, sn as queue_micro_task, sr as set_hydrating, t as active_effect, tt as should_defer_append, ur as CLASS_CACHE, vr as HEAD_EFFECT, wt as derived, x as eager_effect, xr as IS_XHTML, xt as is_flushing_sync, yr as HMR_ANCHOR, yt as flushSync, zn as invalid_snippet, zr as is_array, zt as without_reactive_context } from "./runtime-C9LCcyVl.js";
import { c as NAMESPACE_SVG, i as HYDRATION_ERROR, l as UNINITIALIZED, n as FILENAME, o as NAMESPACE_HTML, r as HMR, s as NAMESPACE_MATHML, t as ATTACHMENT_KEY } from "./constants-CAvLsAYl.js";
import { _ as select_multiple_invalid_value, a as console_log_state, d as hydration_mismatch, f as invalid_raw_snippet_render, g as ownership_invalid_mutation, h as ownership_invalid_binding, i as binding_property_non_reactive, l as hydration_attribute_changed, t as assignment_value_stale, u as hydration_html_changed } from "./warnings-mTRJwfE3.js";
import { a as legacy_mode_flag, t as async_mode_flag } from "./flags-Dg54hJHs.js";
import { f as is_raw_text_element, i as hash, n as can_delegate_event, o as is_capture_event, v as normalize_attribute, y as sanitize_location } from "./utils-uX3Y6KdD.js";
import { a as delegated, i as delegate, r as create_event } from "./events-cFqvuhuU.js";
import { C as assign_nodes, M as create_fragment_from_html, N as create_trusted_html, S as append, g as set_should_intro, r as createClassComponent, v as should_intro } from "./legacy-client-BxOUK89I.js";
import { a as prevent_snippet_stringification, i as to_style, n as clsx, r as to_class } from "./attributes-Cm4IitKt.js";
...
function createRawSnippet(fn) {
	return (anchor, ...params) => {
		...
		if (hydrating) {
			...
			element = /* @__PURE__ */ get_first_child(fragment);
...
function set_custom_element_data(node, prop, value) {
	...
	try {
		if (prop !== "style" && (setters_cache.has(node.getAttribute("is") || node.nodeName) || !customElements || customElements.get(node.getAttribute("is") || node.nodeName.toLowerCase()) ? get_setters(node).has(prop) : value && typeof value === "object")) node[prop] = value;
...
//#endregion
export { remove_input_defaults as $, bind_prop as A, each as At, bind_seekable as B, legacy_api as Bt, bind_window_size as C, component as Ct, bind_this as D, sanitize_slots as Dt, bind_property as E, wrap_snippet as Et, bind_muted as F, await_block as Ft, bind_group as G, assign as Gt, bind_volume as H, hmr as Ht, bind_paused as I, validate_snippet_args as It, customizable_select as J, fromAction as Jt, bind_value as K, assign_async as Kt, bind_playback_rate as L, async as Lt, bind_buffered as M, css_props as Mt, bind_current_time as N, key as Nt, bind_element_size as O, slot as Ot, bind_ended as P, if_block as Pt, attribute_effect as Q, bind_played as R, inspect as Rt, bind_window_scroll as S, raf as St, bind_focused as T, snippet as Tt, bind_checked as U, add_locations as Ut, bind_seeking as V, create_ownership_validator as Vt, bind_files as W, cleanup_styles as Wt, CLASS as X, selectedcontent as Y, STYLE as Z, add_legacy_event_listener as _, head as _t, onDestroy as a, set_value as at, update_legacy_props as b, transition as bt, log_if_contains_state as c, init_select as ct, legacy_rest_props as d, set_selected as dt, set_attribute as et, prop as f, set_style as ft, update_prop as g, append_styles as gt, update_pre_prop as h, action as ht, getAbortSignal as i, set_default_value as it, bind_online as j, index as jt, bind_resize_observer as k, html as kt, create_custom_element as l, select_option as lt, spread_props as m, attach as mt, beforeUpdate as n, set_custom_element_data as nt, onMount as o, set_xlink_attribute as ot, rest_props as p, set_class as pt, bind_active_element as q, createAttachmentKey as qt, createEventDispatcher as r, set_default_checked as rt, hydratable as s, bind_select_value as st, afterUpdate as t, set_checked as tt, validate_binding as u, set_default_select_value as ut, bubble_event as v, element as vt, bind_content_editable as w, createRawSnippet as wt, init as x, loop as xt, reactive_import as y, animation as yt, bind_ready_state as z, check_target as zt };
