...
let props = $props();
const iconData = { "name": "arrow-down-wide-narrow", "size": 24, "node": [["path", { "d": "m3 16 4 4 4-4" }], ["path", { "d": "M7 20V4" }], ["path", { "d": "M11 4h10" }], ["path", { "d": "M11 8h7" }], ["path", { "d": "M11 12h4" }]], "aliases": ["sort-desc"] };
</script>
